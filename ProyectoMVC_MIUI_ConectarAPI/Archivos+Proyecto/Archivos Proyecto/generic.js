...
function EditarGenerico(id) {
    ...
    if (id == 0) {
        ...
        if (objConfiguracionGlobal.callbacknuevo != undefined) {
            objConfiguracionGlobal.callbacknuevo(id);
        }
    }
    //Editar
    else {
                ...
                "text", function (data) {
                    if (data == "1") {
                        ...
                        fetchGet(objConfiguracionGlobal.url, "json", function (rpta) {
                            ...
                            manejoCheck()
                            if (objConfiguracionGlobal.callbackeliminar != undefined) {
                                objConfiguracionGlobal.callbackeliminar();
                            }
                        })
